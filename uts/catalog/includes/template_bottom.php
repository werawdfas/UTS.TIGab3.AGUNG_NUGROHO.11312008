...
<?php
  if ($oscTemplate->hasBlocks('boxes_column_left')) 
  {
	...
	$boxes_column_left_search_modified = str_replace('button_quick_find.gif','button_quick_find_freeoscommerce_003.gif',$boxes_column_left_search_modified);
...
?>
  ...
  if ($oscTemplate->hasBlocks('boxes_column_right')) 
  {
	...
	$boxes_column_right_search_modified = str_replace('button_quick_find.gif','button_quick_find_freeoscommerce_003.gif',$boxes_column_right_search_modified);
...
<!-- Footer -->    
    <div id="footer">
      <div id="footer_content">
        ...
        <br/><br/><a style="font-size: 11px; color: #099509" href="http://zacharycoyne.com/" target="_blank" title="Tucson Web Design">Tucson Web Design</a>
      </div>
